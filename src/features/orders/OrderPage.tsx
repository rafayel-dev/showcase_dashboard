      ...
      render: (courier, record) =>
        editingId?.id === record.id && editingId.field === "courier" ? (
          <InlineEditor
            ...
            onSave={saveEdit}
            onCancel={cancelEdit}
            options={["Pathao", "Steadfast", "RedX"].map((v) => ({
              value: v,
              label: v,
            }))}
            widthClass="w-24"
          ...
          <Space>
            ...
            <AppButton
              ...
              type="text"
              icon={<FiEdit />}
              onClick={() => startEdit(record, "courier")}
            />
          </Space>
        ),
    },
        ...
        editingId?.id === record.id && editingId.field === "paymentStatus" ? (
          ...
          <Space>
            ...
            <AppButton
              ...
              type="text"
              icon={<FiEdit />}
              onClick={() => startEdit(record, "paymentStatus")}
            />
          </Space>
        ),
    },
      ...
      <Row gutter={16} className="mt-4">
        {[
          ...
          },
          {
            ...
            icon: <HistoryOutlined className="text-[#f59e0b]! mr-2!" />,
          },
          {
            title: "Processing",
            value: orders.filter((o) => o.status === "Processing").length,
            icon: <FieldTimeOutlined className="text-[#3b82f6]! mr-2!" />,
          },
          {
            title: "Shipped",
            value: orders.filter((o) => o.status === "Shipped").length,
            icon: <TruckOutlined className="text-[#6366f1]! mr-2!" />,
          },
          {
            title: "Delivered",
            value: orders.filter((o) => o.status === "Delivered").length,
            icon: <CheckCircleOutlined className="text-[#22c55e]! mr-2!" />,
          },
          {
            title: "Cancelled",
            value: orders.filter((o) => o.status === "Cancelled").length,
            icon: <CloseCircleOutlined className="text-[#ef4444]! mr-2!" />,
          },
        ].map((stat, i) => (
          <Col md={4} key={i}>
            <StatsCard
