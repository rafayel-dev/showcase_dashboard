...
const DUMMY_PRODUCTS = [
  ...
  },
  {
    ...
    status: "Active",
    imageUrl:
      "https://images.unsplash.com/photo-1546868871-7041f2a55e12?q=80&w=1464&auto=format&fit=crop",
    views: 890,
    orders: 156,
      ...
      {viewMode === "table" ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredProducts.map((p) => (
            <Card
              key={p.id}
              className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all border-gray-100"
              bodyStyle={{ padding: 0 }}
            >
              <div className="relative h-48 bg-gray-100">
                ...
                <div className="absolute top-3 right-3">
                  <Tag
                    ...
                    className="m-0 bg-white/90 backdrop-blur border-none font-bold"
                  >
                    {p.status}
                  </Tag>
                </div>
              ...
              <div className="p-4">
                <Text strong className="block text-lg mb-1 truncate">
                  {p.productName}
                </Text>
                ...
                <div className="flex justify-between items-end">
                  <div>
                    {p.discountPrice ? (
                      <div className="flex items-baseline gap-2">
                        <Text strong className="text-xl text-violet-600">
                          ৳{p.discountPrice}
                        </Text>
                  ...
                  <AppButton
                    ...
                    size="small"
                    icon={<FiEdit size={20} className="text-violet-500!" />}
                  />
                </div>
              </div>
            </Card>
