  ...
  const columns: TableProps<any>["columns"] = [
    {
      ...
      render: (id, r) => (
        <div className="flex flex-col">
          <Text strong className="text-violet-600">
            {id}
          </Text>
      ...
      render: (name, r) => (
        <div className="flex flex-col">
          ...
          <Text type="secondary" className="text-xs flex items-center gap-1">
            <PhoneOutlined /> {r.customerMobile}
          </Text>
        </div>
      ),
    },
    ...
    },
    {
      ...
      render: (status, r) => (
        <Switch
          ...
          onChange={(checked) =>
            handleOrderStatusChange(r.id, checked ? "Confirmed" : "Pending")
          }
          checkedChildren="Yes"
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <Tabs
          ...
          items={["All", "Pending", "Confirmed", "Delivered", "Cancelled"].map(
            (k) => ({
              key: k,
              label: (
      ...
      >
        {viewOrder && (
          <div className="space-y-6">
            {/* Status Banner */}
            <div
              className={`p-4 rounded-xl flex justify-between items-center ${viewOrder.status === "Cancelled" ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
            >
              <div>
                ...
                <Text className="opacity-80">
                  Placed on {new Date(viewOrder.orderDate).toLocaleString()}
                </Text>
              </div>
              <div className="flex flex-col">
                ...
                >
                  <div className="flex flex-col gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <Text className="block text-gray-500 text-xs uppercase">
                          Customer
                        </Text>
