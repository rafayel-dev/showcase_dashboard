...
const PromotionPage: React.FC = () => {
  const { data: sliders = [], isLoading: tableLoading } =
    ...
    },
    {
      ...
      render: (isActive: boolean, record: any) => (
        <Switch
          ...
          checked={isActive}
          onChange={(checked) =>
            updateSlider({ id: record._id, isActive: checked })
          }
        />
      ),
    },
      ...
      render: (_: any, record: any) => (
        <Space>
          <Tooltip title="Edit Slide">
            <AppButton icon={<FiEdit2 />} onClick={() => handleEdit(record)}>
              Edit
            </AppButton>
          </Tooltip>
          <AppPopconfirm
